...
def register_mujoco_envs():
    ...
    from gcsl_dependencies.multiworld.envs.mujoco.cameras import (
...
def create_image_48_sawyer_reach_xy_env_v1():
    ...
    from gcsl_dependencies.multiworld.envs.mujoco.cameras import sawyer_xyz_reacher_camera_v0
...
def create_image_48_sawyer_door_hook_reset_free_v1():
    from gcsl_dependencies.multiworld.core.image_env import ImageEnv
    from gcsl_dependencies.multiworld.envs.mujoco.cameras import sawyer_door_env_camera_v0
    import os.path
    import numpy as np
...
def create_image_48_sawyer_pickup_easy_v0():
    from gcsl_dependencies.multiworld.core.image_env import ImageEnv
    from gcsl_dependencies.multiworld.envs.mujoco.cameras import sawyer_pick_and_place_camera
    import os.path
    import numpy as np
    goal_path = os.path.join(
        os.path.dirname(os.path.realpath(__file__)),

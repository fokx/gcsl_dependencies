...
from gcsl_dependencies.rlutil.viskit.ext import flatten
from gcsl_dependencies.rlutil.viskit import core
from gcsl_dependencies.rlutil.viskit import ext
import sys
import argparse
import json
import numpy as np
...
def make_plot(plot_list, use_median=False, plot_width=None, plot_height=None, title=None):
    ...
    for idx, plt in enumerate(plot_list):
        ...
        data.append(go.Scatter(
            ...
            line=go.Line(color='rgba(0,0,0,0)'),
            showlegend=False,

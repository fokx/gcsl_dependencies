...
_REGISTERED = False
def register_envs():
    from gcsl_dependencies.rlutil.envs.gridcraft.mazes import MAZE1, MAZE_LAVA
    from gcsl_dependencies.rlutil.envs.gridcraft.grid_spec import REWARD, LAVA
    from gcsl_dependencies.rlutil.envs.env_utils import CustomGymEnv
    from gcsl_dependencies.rlutil.envs.tabular.simple_env import random_env_register

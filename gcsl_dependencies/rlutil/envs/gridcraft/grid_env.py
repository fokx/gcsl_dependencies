...
from gcsl_dependencies.rlutil.envs.gridcraft.grid_spec import REWARD, REWARD2, REWARD3, REWARD4, WALL, LAVA, TILES, START, RENDER_DICT
...
class GridEnv(gym.Env):
    ...
    def step(self, a, verbose=False):
        ns, r = self.step_stateless(self._state, a, verbose=verbose)
        traj_infos = {}
        self._state = ns

import gcsl_dependencies.rlutil.torch.nn
from gcsl_dependencies.rlutil.torch.pytorch_util import set_gpu, default_device, to_numpy
...
def _replace_funcs(global_dict):
    ...
    for _key in dir(th):
        ...
        if _value.__doc__ and 'device (:class:`torch.device`, optional):' in str(_value.__doc__):

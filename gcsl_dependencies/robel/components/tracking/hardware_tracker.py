...
from gcsl_dependencies.robel.components.tracking.tracker import (
    TrackerComponent, TrackerGroupConfig, TrackerState)
from gcsl_dependencies.robel.components.tracking.utils.coordinate_system import (
    CoordinateSystem)
from gcsl_dependencies.robel.utils.math_utils import average_quaternions
...
class HardwareTrackerComponent(TrackerComponent):
    ...
    def show_plot(self, auto_update: bool = False, frame_rate: int = 10):
        ...
        if self._plot and self._plot.is_open:
            return
        from gcsl_dependencies.robel.utils.plotting import AnimatedPlot

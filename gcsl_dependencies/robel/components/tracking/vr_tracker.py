...
from gcsl_dependencies.robel.components.tracking.hardware_tracker import (
...
class VrTrackerComponent(HardwareTrackerComponent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self._VR_CLIENT is None:
            from gcsl_dependencies.robel.components.tracking.virtual_reality.client import (
                VrClient)
